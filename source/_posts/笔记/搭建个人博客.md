...
(2)安装
<div align="left">![](/img/note_02/01.png)</div>
<div align="left">![](/img/note_02/02.png)</div>
<div align="left">![](/img/note_02/03.png)</div>
<div align="left">![](/img/note_02/04.png)</div>
...
首先创建一个文件夹`Hexo`
<div align="left">![](/img/note_02/05.png)</div>
...
```
如下图：
<div align="left">![](/img/note_02/06.png)</div>
...
└── themes
```
<div align="left">![](/img/note_02/07.png)</div>
...
<div align="left">![](/img/note_02/08.png)</div>
...
<div align="left">![](/img/note_02/11.png)</div>
...
snippet主题demo网站:
<div align="left">![](/img/note_02/12.png)</div>
...
添加后效果如下：
<div align="left">![](/img/note_02/13.png)</div>

### 7、其他技巧 ###
文章中添加图片`source`下新建`img`文件夹,该文件夹下放入图片,可针对不同文章，进行创建文件夹。

<div align="left">![](/img/note_02/14.png)</div>
...
<div align="left">![](/img/note_02/15.png)</div>

### 1、注册github ###
官网网站:[https://github.com/][7]
<div align="left">![](/img/note_02/16.png)</div>

### 2、创建项目 ###
这里建议创建两个项目。`BlogCode`和`Blog`项目。此处只说明`Blog`创建过程
<div align="left">![](/img/note_02/17.png)</div>
<div align="left">![](/img/note_02/18.png)</div>
<div align="left">![](/img/note_02/19.png)</div>
...
<div align="left">![](/img/note_02/20.png)</div>
`git add .` add 所有文件
<div align="left">![](/img/note_02/21.png)</div>
`git status .` 查看已add的文件
<div align="left">![](/img/note_02/22.png)</div>
`git commit`提交文件
<div align="left">![](/img/note_02/23.png)</div>
输入提交记录
<div align="left">![](/img/note_02/24.png)</div>
`git remote add orgin https://gitbub.com/***/BlogCode.git`
`git push origin master`
输入git 用户名和密码
<div align="left">![](/img/note_02/25.png)</div>
之后可在github 上看到已入库的代码
<div align="left">![](/img/note_02/26.png)</div>
（2）、Blog
Blog需要上传的代码主要为`public`目录下的文件
```sh
hexo g
```
<div align="left">![](/img/note_02/27.png)</div>
Blog上传方式比较简单，需要修改`Hexo->_config.yml`文件
<div align="left">![](/img/note_02/28.png)</div>
之后操作
```sh
...
hexo deploy
```
<div align="left">![](/img/note_02/29.png)</div>
...
<div align="left">![](/img/note_02/30.png)</div>
<div align="left">![](/img/note_02/31.png)</div>
（2）浏览器`账户名.github.io`
<div align="left">![](/img/note_02/32.png)</div>

### 3、使用购买域名(.top)访问 ###
可为购买的域名添加前缀比如“`blog`”。CNAME 记录 将“blog.xx.top”重定向到“xx.github.io”。
在阿里域名解析添加：
<div align="left">![](/img/note_02/33.png)</div>
